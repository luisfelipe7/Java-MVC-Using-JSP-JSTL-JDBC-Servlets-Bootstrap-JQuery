...
<body>
	...
	<br>
	Favorite Frameworks:
	<!-- Displaying here the list of favorite frameworks-->
	<ul>
		<%
		String[] listOfCheckedFrameworks = request.getParameterValues("favoriteFrameworks");
		if (listOfCheckedFrameworks.length != 0) {
		    for (String checkedFramework : listOfCheckedFrameworks) {
			out.println("<li>" + checkedFramework + "</li>");
		    }
		}
		%>
	</ul>
